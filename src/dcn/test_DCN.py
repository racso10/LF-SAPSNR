...
def check_dconv_zero_offset():
    ...
    if d < 1e-5:
        print('dconv zero coord_generation passed with {}'.format(d))
    else:
        print('dconv zero coord_generation failed with {}'.format(d))
        # print(output_p)
        # print(output_d)
...
def check_mdconv_zero_offset():
    ...
    d = (output_d - output_p).abs().max()
    if d < 1e-5:
        print('mdconv zero coord_generation passed with {}'.format(d))
    else:
        print('mdconv zero coord_generation failed with {}'.format(d))
        # print(output_p)
        # print(output_d)
        print((output_d - output_p).abs())
...
def check_dconv_zero_offset_identify():
    ...
    if d < 1e-10:
        print('dconv zero coord_generation identify passed with {}'.format(d))
    else:
        print('dconv zero coord_generation identify failed with {}'.format(d))
        # print(input)
        # print(output)
...
def check_mdconv_zero_offset_identify():
    ...
    d = (input - output).abs().max()
    if d < 1e-10:
        print('mdconv zero coord_generation identify passed with {}'.format(d))
    else:
        print('mdconv zero coord_generation identify failed with {}'.format(d))
        # print(input)
        # print(output)
        print((input - output).abs())
...
def check_dconv_im2col_step_backward():
    ...
    # coord_generation.data.zero_()
    # coord_generation.data -= 0.5
    ...
    if grad_err:
        print(
            "dconv im2col_step backward passed with {} = {}+{}+{}+{}".format(grad_err, input_grad_err, offset_grad_err,
                                                                             weight_grad_err, bias_grad_err))
    else:
        print(
            "dconv im2col_step backward failed with {} = {}+{}+{}+{}".format(grad_err, input_grad_err, offset_grad_err,
                                                                             weight_grad_err, bias_grad_err))
...
def check_mdconv_im2col_step_backward():
    ...
    output1 = _ModulatedDeformConv(input, offset, mask, weight, bias, stride, padding, dilation, groups,
                                   deformable_groups, 2)
    targert = torch.rand(*output1.size()).cuda()
    error = (targert - output1).mean()
    error.backward(retain_graph=True)
    ...
    weight_grad = weight.grad.clone()
    bias_grad = bias.grad.clone()
    output2 = _ModulatedDeformConv(input, offset, mask, weight, bias, stride, padding, dilation, groups,
                                   deformable_groups, 1)
    error2 = (targert - output2).mean()
    error.backward()
    print((output1 - output2).abs().max())
...
def check_gradient_dconv():
    ...
    # print('check_gradient_dconv: ',
    #       gradcheck(_DeformConv, (input, coord_generation, weight, bias,
    #                 stride, padding, dilation, deformable_groups)))
...
def example_dconv():
    ...
    # wrap all things (coord_generation and mask) in DCN
