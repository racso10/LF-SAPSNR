...
if __name__ == '__main__':
    ...
    # python test.py -i /mnt/nfsData10/ChangSong/Dataset/hci_dataset/ -m ../pretrain_model/ -in 2 -out 7 -e 1 -d Syn -dn HCI -imc 0 -g 2
    ...
    #
    # if datasets == 'HCI':
    #     datasets_name_list = ['HCI', 'HCI_old', 'DLFD']
    #     is_multi_channel = False
    # elif datasets == 'Lytro':
    #     datasets_name_list = ['30scenes', 'occlusions', 'reflective']
    #     is_multi_channel = False
    # elif datasets == 'Stanf':
    #     datasets_name_list = ['stanford']
    #     is_multi_channel = True
    # else:
    #     print('Unrecognized datasets')
    #     exit()
    #
    # for datasets_name in datasets_name_list:
    #     test_main(
    #         img_path='/mnt/nfsData10/ChangSong/Dataset/hci_dataset/',
    #         # img_path='/mnt/nfs-storage-node-10/Dataset/hci_old_dataset/',
    #         # img_path='/mnt/nfs-storage-node-10/Dataset/Inria_syn_lf_datasets/DLFD/',
    #         # img_path='/mnt/nfs-storage-node-10/Dataset/all_datasets/',
    #         # img_path='/mnt/nfsData10/ChangSong/Dataset/stanford_half_full_png/',
    #         model_path='../pretrain_model/',
    #         # model_path='../net_store/',
    #         view_n_in=view_n_in,
    #         view_n_out=view_n_out,
    #         extra=extra,
    #         datasets=datasets,
